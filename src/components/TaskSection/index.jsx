...
class TaskSection extends React.Component {
  ...
  render() {
    ...
    const activeTasks = activeTaskFilter.map(task => (
      <li className="tasks__task" key={task._id}>
        <div className="tasks__task__title">
          <button
            title="deactivate"
            className="tasks__task__check"
            onClick={e => this.handleStatusChange(e, task._id, task.status)}
        ...
        <div className="tasks__task__options">
          <Link to={`/dashboard/${task._id}`} className="tasks__task__expand">
            expand
          </Link>
          <button
            title="delete"
      ...
      <Fragment>
        <div className="task-section">
          <section className="day">
            ...
            <div>
              <div className="day__title__box">
                <h2 className="day__title inactive">Inactive projects</h2>
              </div>
